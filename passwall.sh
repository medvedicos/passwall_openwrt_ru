...
wget -O passwall.pub https://sourceforge.net/project/openwrt-passwall-build/passwall.pub
...
for feed in passwall_luci passwall_packages passwall2; do
  echo "src/gz $feed https://sourceforge.net/project/openwrt-passwall-build/releases/packages-$release/$arch/$feed" >> /etc/opkg/customfeeds.conf
done
